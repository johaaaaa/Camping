...
export default {
    methods: {
        search: function () {
            ...
            if (select == '중고장터') {
                location.href = "http://localhost:8087/java/used/usedMain?search=" + search
            } else if (select == '어디갈래?') {
                location.href = "http://localhost:8087/java/CampList?search=" + search
            } else if (select == '같이갈래?') {
                location.href = "http://localhost:8087/java/RecruList?search=" + search
            } else if (select == '후기피드') {
                location.href = "http://localhost:8087/java/sns/undefined?search=" + search
            }
        },
        hashtag: function(e){

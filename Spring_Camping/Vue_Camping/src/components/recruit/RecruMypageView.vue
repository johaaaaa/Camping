          ...
          <div class="container row">
              ...
              <div class="recru-card-box row">
                  <div v-for="recruInfo in recruPosts" :key="recruInfo.title" style="position:relative">
                    <div class = "recru-entry-chk" style="position:absolute; top:21px; right: 21px; z-index:20;" >
                        <NewEntry :recruId="recruInfo.recruId"></NewEntry>
                    </div>
                    <RecruStatus :recruStatus="recruInfo.recruStatus" style="position:absolute;width:70px;font-size:small;font-weight: bold; top:0;left: 20px;z-index: 20;"></RecruStatus>

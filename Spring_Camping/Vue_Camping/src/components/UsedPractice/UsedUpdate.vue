        ...
        <div class="used-info">
          <ul>
            ...
            <li>
              ...
              <input type="text" name="usedName" id="inputName" placeholder="상품명을 등록해주세요(최대 20자)" maxlength="20"
                autofocus :value="usedList.usedName">
            </li>
            <li>
            ...
            <li>
              ...
              <div class="usedPlace">
                <select name="usedPlace" id="districtSelect" @change="districtChange">
    ...
    fetch('http://localhost:8087/java/used/usedDetail/' + this.usedId)
      ...
      .then(data => {
        ...
        if (data.usedPlace != '전체' && data.usedPlace != null) {
          ...
          let dis = document.querySelector('#districtSelect');
          dis.value = places[0];
          this.districtChange();
